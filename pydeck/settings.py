    ...
    "default": {
        ...
        "toolbar_Custom": [
            ...
            [
                ...
                "Table",
                "Youtube",
            ],  # Добавлены кнопки для вставки изображений и YouTube видео
            ["Maximize"],
            ["Styles", "Format", "Font", "FontSize"],
            ["TextColor", "BGColor"],
            ["CodeSnippet"],  # Добавлена кнопка для вставки кода
        ],
        "extraPlugins": ",".join(
            [
                "uploadimage",  # Плагин для загрузки изображений
                "image2",  # Плагин для улучшенного управления изображениями
                "codesnippet",  # Плагин для вставки кода
